...
namespace CoolingGridManager.Exceptions
{
    // Not Found
    ...
    public class FormatException : Exception
    {
        ...
        public DateTime Timestamp { get; } = DateTime.UtcNow;
        public FormatException(string message, string sourceRequested) : base(message)
        {
        ...
        public override string ToString()
        {
            return $"Format Exception on [{Timestamp:yyyy-MM-dd HH:mm:ss.fff}] using '{SourceRequested}'. Message: {Message}\n{StackTrace}";
        }
    }
